...
def advanced_search_company(company_name_includes=None, company_name_excludes=None, company_status=None, company_subtype=None, company_type=None, dissolved_from=None, dissolved_to=None, incorporated_from=None, incorporated_to=None, location=None, sic_codes=None, size=None, start_index=None):
    """
    Performs an advanced search for companies based on various filters.

    Parameters
    ----------
    company_name_includes : str, optional
        The company name includes advanced search filter.
    company_name_excludes : str, optional
        The company name excludes advanced search filter.
    company_status : list, optional
        The company status advanced search filter.
    company_subtype : str, optional
        The company subtype advanced search filter.
    company_type : list, optional
        The company type advanced search filter.
    dissolved_from : str, optional
        The dissolved from date advanced search filter.
    dissolved_to : str, optional
        The dissolved to date advanced search filter.
    incorporated_from : str, optional
        The incorporated from date advanced search filter.
    incorporated_to : str, optional
        The incorporated to date advanced search filter.
    location : str, optional
        The location advanced search filter.
    sic_codes : list, optional
        The SIC codes advanced search filter.
    size : str, optional
        The maximum number of results matching the search term(s) to return.
    start_index : str, optional
        The point at which results will start from.
    ...
    try:
        ...
        params = {
            ...
            "company_status": ",".join(company_status) if company_status else None,
            "company_subtype": company_subtype,
            "company_type": ",".join(company_type) if company_type else None,
        ...
        response = make_get_request(base_url, headers=None, params=params)
        search_results = response.json()
        return search_results

    except Exception as e:
        print(f"Error occurred while performing advanced search: {e}")
        return None
